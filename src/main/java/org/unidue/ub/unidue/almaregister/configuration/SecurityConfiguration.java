    ...
    public static class ApiSecurityConfiguration extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity httpSecurity) throws Exception {
            ...
            httpSecurity.
                    ...
                    and().addFilter(filter).authorizeRequests().anyRequest().access( "hasIpAddress('95.172.90.160/27') or hasIpAddress('31.186.254.128/28') or hasIpAddress('216.147.214.128/26') or hasIpAddress('216.147.218.128/26') or hasIpAddress('216.147.218.64/26') or hasIpAddress('216.147.215.0/27') or hasIpAddress('192.170.176.1') or hasIpAddress('132.252.200.205') or hasIpAddress('127.0.0.1')");
        }
    }
