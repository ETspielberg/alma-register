 ...
 */
@ApiModel(description = "The user's preferred language. Possible codes are listed in 'User Preferred Language' [code table](https://developers.exlibrisgroup.com/blog/Working-with-the-code-tables-API). Default: en. On SIS synch this field will not be replaced if it was updated manually (or if empty in the incoming user record). For external users in PUT action: this field will not be replaced if it was updated manually (or if empty in the incoming user record), unless 'override' parameter is sent with the field's name. See [blog](https://developers.exlibrisgroup.com/blog/External-user-data-behavior-of-SIS-synchronization-and-API) for more details.")
@JsonPropertyOrder({
  UserPreferredLanguage.JSON_PROPERTY_DESC,
  UserPreferredLanguage.JSON_PROPERTY_VALUE
})

@XmlRootElement(name = "User2PreferredLanguage")
@XmlAccessorType(XmlAccessType.FIELD)
@JacksonXmlRootElement(localName = "User2PreferredLanguage")
public class UserPreferredLanguage implements Serializable {
  ...
  public UserPreferredLanguage desc(String desc) {
  ...
  **/
  ...
  public UserPreferredLanguage value(String value) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserPreferredLanguage userPreferredLanguage = (UserPreferredLanguage) o;
    return Objects.equals(this.desc, userPreferredLanguage.desc) &&
        Objects.equals(this.value, userPreferredLanguage.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class User2PreferredLanguage {\n");
