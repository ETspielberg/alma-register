 ...
 */
@ApiModel(description = "The user's title Possible codes are listed in the 'UserTitles' [code table](https://developers.exlibrisgroup.com/blog/Working-with-the-code-tables-API). On SIS synch this field will not be replaced if it was updated manually (or if empty in the incoming user record). For external users in PUT action: this field will not be replaced if it was updated manually (or if empty in the incoming user record), unless 'override' parameter is sent with the field's name. See [blog](https://developers.exlibrisgroup.com/blog/External-user-data-behavior-of-SIS-synchronization-and-API) for more details.")
@JsonPropertyOrder({
  UserUserTitle.JSON_PROPERTY_DESC,
  UserUserTitle.JSON_PROPERTY_VALUE
})

@XmlRootElement(name = "User2UserTitle")
@XmlAccessorType(XmlAccessType.FIELD)
@JacksonXmlRootElement(localName = "User2UserTitle")
public class UserUserTitle implements Serializable {
  ...
  public UserUserTitle desc(String desc) {
  ...
  **/
  ...
  public UserUserTitle value(String value) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserUserTitle user2UserTitle = (UserUserTitle) o;
    return Objects.equals(this.desc, user2UserTitle.desc) &&
        Objects.equals(this.value, user2UserTitle.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class User2UserTitle {\n");
